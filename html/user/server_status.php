...
function show_status_html($x) {
    ...
    item_html("cudasieve results completed", $j->cs_past_24_hours);
...
function get_job_status() {
    ...
    $s->cs_past_24_hours = BoincResult::count("(appid=13 or appid=14 or appid=15) and outcome=1 and granted_credit>0 and received_time > (unix_timestamp() - 86400)");
